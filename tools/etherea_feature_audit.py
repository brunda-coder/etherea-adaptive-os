...
FEATURES: list[Check] = [
    ...
    Check(3, "home command input voice-first", [("corund/ui/ethera_command_bar.py", "HomeCommandInputController"), ("corund/app_controller.py", "_init_voice_deferred")], "runtime_selftest mic_pipeline", "Visible command bar accepts voice commands."),
    ...
    Check(5, "aurora adapts to time/mood/focus/stress", [("corund/aurora_adaptation.py", "AuroraAdaptationEngine"), ("corund/ui/aurora_ring_widget.py", "set_state")], "runtime_selftest imports", "Aura changes color/behavior by state."),
    Check(6, "stress/focus from keyboard+mouse", [("corund/stress_focus.py", "compute_stress_focus"), ("sensors/keyboard_sensor.py", "KeyboardSensor"), ("sensors/mouse_sensor.py", "MouseSensor")], "tests/test_sensors.py", "Focus/stress follows HID intensity."),
